...
export const TRANSLATIONS = {
  ko: {
    ...
    stockNewsLoading: 'AI가 최신 주요 뉴스를 분석 중입니다...',
    stockNewsError: '최신 뉴스 요약을 불러오지 못했습니다. 잠시 후 다시 시도해 주세요.',
    stockNewsTimeout: '뉴스 요약 요청 시간이 초과되었습니다.',
    stockNewsEmpty: '현재 확인 가능한 주요 뉴스가 없습니다.',
    stockNewsSources: '주요 기사',
    close: '닫기',
    noData: '데이터 없음',
  },
  en: {
    ...
    stockNewsLoading: 'AI is analyzing the latest major news...',
    stockNewsError: 'Failed to load the latest news brief. Please try again shortly.',
    stockNewsTimeout: 'The news brief request timed out.',
    stockNewsEmpty: 'No major news is available right now.',
    stockNewsSources: 'Top stories',
    close: 'Close',
    noData: 'No data',
  },
  ja: {
    ...
    stockNewsLoading: 'AIが最新の主要ニュースを分析しています...',
    stockNewsError: '最新ニュース要約を読み込めませんでした。しばらくしてから再度お試しください。',
    stockNewsTimeout: 'ニュース要約リクエストがタイムアウトしました。',
    stockNewsEmpty: '現在確認できる主要ニュースはありません。',
    stockNewsSources: '主要記事',
    close: '閉じる',
    noData: 'データなし',
  },
};
