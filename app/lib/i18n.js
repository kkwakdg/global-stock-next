...
export const TRANSLATIONS = {
  ko: {
    ...
    exchangeRateNote: '원화와 엔화 시가총액은 실시간 환율을 기준으로 환산됩니다.',
    close: '닫기',
    noData: '데이터 없음',
  },
  en: {
    ...
    exchangeRateNote: 'KRW and JPY market caps are converted with live exchange rates.',
    close: 'Close',
    noData: 'No data',
  },
  ja: {
    ...
    exchangeRateNote: 'ウォンと円の時価総額はリアルタイム為替レートで換算されます。',
    close: '閉じる',
    noData: 'データなし',
  },
};
